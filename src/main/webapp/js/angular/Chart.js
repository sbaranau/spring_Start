	...
	Chart.defaults = {
		global: {
			...
			legendCallback: function(chart) {
				...
				var text = [];
				text.push('<div class="flex-table-row" style="justify-content:flex-start">');
				for (var i = 0; i < chart.data.datasets.length; i++) {

					text.push('<div class="flex-table-cell" style="width:inherit">' +
					            '<span  class="glyphicon glyphicon-plus" style="color:transparent; background-color:' + chart.data.datasets[i].pointBackgroundColor + '">');
					text.push('</span><span>');
